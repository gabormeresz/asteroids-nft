...
const HomeStaticContent = () => {
  const asteroidsImgClassName = "rounded-3xl w-1/5 p-2";

  return (
    <div className="flex flex-col items-center gap-10">
      <h1
        className={`uppercase text-3xl tracking-widest font-light ${jura.variable} font-mono text-white`}
      >
        The Asteroids Collection
      </h1>
      <div className="flex flex-row items-center justify-between max-w-4xl px-2 ">
        <Image
          src={asteroid1}
          alt="asteroid"
